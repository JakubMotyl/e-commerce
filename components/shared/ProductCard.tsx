        ...
        <div className="flex flex-col rounded overflow-hidden mx-auto">
            ...
            <div className="flex-1 flex flex-col gap-1.5">
                <div className="w-full flex-1">
                    <button
                        className="w-full h-full bg-terracotta hover:bg-black cursor-pointer transition-all duration-300 text-white"
                ...
                <div className="flex items-center justify-between gap-10">
                    ...
                    <p className="text-black md:text-base text-sm font-logo whitespace-nowrap">
                        {product.price} $
                    </p>
                </div>
            </div>
